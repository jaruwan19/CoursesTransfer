...
class RequestToClassPlanController extends Controller
{
    ...
    {
        $user = [
            'classPlane_name' => 'ดร.ปฏิมากร จริยฐิติพงศ์',
        ];
        ...
        return view('classPlan.student_request', compact('user', 'student_requests'));
    }
    ...
    public function showDataRequest()
    {
        ...
        return view('classPlan.check_subjects', compact('user', 'system_request', 'type_transfer', 'subject_transfer', 'original_subjects', 'current_subjects'));
    }
    ...
    public function showResultCheck()
    {
        ...
        return view('classPlan.result_check', compact('user', 'system_request', 'type_transfer', 'subject_transfer', 'original_subjects', 'current_subjects', 'result'));
    }
    ...
    public function showDataPreview()
    {
        ...
        return view('classPlan.data_preview', compact('user', 'system_request', 'type_transfer', 'subject_transfer', 'original_subjects', 'current_subjects', 'result'));
    }
}
