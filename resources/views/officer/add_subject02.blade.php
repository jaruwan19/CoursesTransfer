                ...
                <div class="container">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select name="type_course" class="form-control" width="100%"required>
                                <option value="" disabled selected hidden></option>
                                <option value="วิศวกรรมซอฟต์แวร์">ศึกษาทั่วไป 24 หน่วยกิต</option>
