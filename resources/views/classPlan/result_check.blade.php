        ...
        <form action="" class="form">
            ...
            <div class="container-form ">
                {{-- @foreach ($type_transfer as $transfer)
                    ...
                    @endforeach --}}
                <div class="row p-0">
                    <h5 class="text-darkblue"><i class="bi bi-caret-right-fill"></i>
                        {{ $type_transfer[0]['type_transfer'] }}</h5>
                </div>
                <table class="table">
            ...
            <div class="container-form">
                <div class="row p-0">
                    <h5 class="text-darkblue"><i class="bi bi-caret-right-fill"></i>
                        {{ $type_transfer[3]['type_transfer'] }}</h5>
                    {{-- <h5 class="text-darkblue" ><i class="bi bi-caret-right-fill">{{ $transfer['type_transfer']}}</h5> --}}
                </div>
                ...
                <div class="row align-items-center text-darkblue fs-5">
                    ...
                    <div class="col-auto">
                        <input class="form-control text-center fw-bold border-0 bg-white shadow-sm px-3 fs-5" type="text"
                            value="18" readonly style="max-width: 100px;">
                    </div>
            ...
            <div class="p-2 mt-3 mb-3 d-flex justify-content-between">
                <a href="{{ url('check_subjects') }}" class="btn btn outline-darkblue btn-lg " name="cancle">ย้อนกลับ</a>
