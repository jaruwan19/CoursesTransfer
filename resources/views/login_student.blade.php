            ...
            <div class="card shadow-sm p-3 mb-5 bg-body-tertiary rounded">
                <div class="card-body">
                    <form action="" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="username" class="form-label text-darkblue fw-bold">รหัสนักศึกษา</label>
                            <input type="number" class="form-control" id="username" name="username" required>
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label text-darkblue fw-bold">รหัสบัตรประจำตัวประชาชน</label>
